...
Table 2 shows a subset of the top three outcome types per animal species. For animals with less than three outcome types, all of their outcome types are shown in the table. Using Table2, Cats had the highest rescue rate, and dogs had the highest rate of being returned to their owner. A large number of cats and dogs get adopted with it being the second highest outcome for each animal. Wild animals had a very high euthanasia rate compared to its other outcomes.
